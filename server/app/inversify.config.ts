...
DrawingSessionControllerInterface} from "./interfaces";
...
container.bind<DrawingSessionControllerInterface>(TYPES.DrawingSessionControllerInterface).to(DrawingSessionController);
